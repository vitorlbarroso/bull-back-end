...
class MembersAreaOffersIntegrationsRequest extends FormRequest
{
...
//        }
    ...
    {
        return [
            'members_area_id' => 'required|integer|exists:members_area,id',
    ...
    {
        return [
            'members_area_id.required' => 'O ID da área de membro é obrigatório.',
