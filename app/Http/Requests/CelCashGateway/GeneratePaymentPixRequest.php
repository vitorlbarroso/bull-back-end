...
class GeneratePaymentPixRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'tracking_parameters.src' => 'nullable|string',
            'tracking_parameters.sck' => 'nullable|string',
            'tracking_parameters.utm_source' => 'nullable|string',
            'tracking_parameters.utm_campaign' => 'nullable|string',
            'tracking_parameters.utm_medium' => 'nullable|string',
            'tracking_parameters.utm_content' => 'nullable|string',
            'tracking_parameters.utm_term' => 'nullable|string',
